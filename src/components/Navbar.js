                    ...
                    <ul className={`navlinks ${scrolled ? 'scrolled' : ''}`}>
                        {
                            NavItems.map((item, index) => {
                                return (
                                    <li className={`nav-link${props.black ? ' black' : ''}`} key={index}>
